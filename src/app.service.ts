...
export class AppService {
  ...
  getStatus(): ImethodCommonResponse {
    const res = {
      ...
      data: {
        environment: envVariables.environment.nodeEnv ?? 'unknown',
        appName: envVariables.application.appName ?? 'unknown',
        appVersion: envVariables.application.appVersion ?? 'unknown',
      },
    };
